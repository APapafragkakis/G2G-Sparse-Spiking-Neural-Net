...
# Linear layer with random grouping and G2G-style sparsity
class RandomGroupSparseLinear(nn.Module):
    ...
    def _build_mask(self) -> torch.Tensor:
        """Construct a binary mask using random grouping."""
        ...
        # Apply permutations to obtain random groups
...
class RandomSNN(nn.Module):
    def __init__(
        ...
        # Fully-connected layers with random-group sparse connectivity
        self.fc1 = RandomGroupSparseLinear(
        ...
        self.fc2 = RandomGroupSparseLinear(
        ...
        self.fc3 = RandomGroupSparseLinear(
            in_features=hidden_dim,
            out_features=hidden_dim,
            num_groups=num_groups,
            p_intra=p_intra,
